...
// // //real world example:using push method to add new student in the students array
// // const students=["GAURAV","HASSAN","VINNET"]//array definition
// // const newStudents=students.push("MAYUR")//using push method to add element at the end of the array
// // console.log(newStudents)//array after adding the element
...
// //real world example:using pop method to remove the last student from the students array
// const students=["GAURAV","HASSAN","VINNET"]//array definition
// const removedStudent=students.pop()//using pop method to remove the last element of the array
// console.log(removedStudent)//pop method returns the removed element
...
// real world example:Add a new emergency alert at the top of notifications
const notifications=["Message from Gaurav","Message from Hassan","Message from Vinnet"]//array definition
const newNotification=notifications.unshift("Emergency Alert: System Down")//using unshift method to add element at the beginning of the array
console.log(newNotification)//unshift method returns the length of the array after adding the element
console.log(notifications)//array after adding the element
...
//real world example:Remove the oldest notification from the notifications array
const notifications1=["Message from Gaurav","Message from Hassan","Message from Vinnet"]//array definition
const removedNotification=notifications1.shift()//using shift method to remove the first element of the array
console.log(removedNotification)//shift method returns the removed element
console.log(notifications1)//array after removing the first element
...
//real world example:Extract the first two notifications from the notifications array
const notifications2=["Message from Gaurav","Message from Hassan","Message from Vinnet"]//array definition
const firstTwoNotifications=notifications2.slice(0,2)//using slice method to extract a portion of the array
console.log(firstTwoNotifications)//slice method returns a new array
console.log(notifications2)//original array is not modified after using slice method because slice method does not modify the original array and returns a new array
...
//real world example:Remove the a contact from the contacts array
const contacts=["Gaurav","Hassan","Vinnet"]//array definition
const removedContact=contacts.splice(1,2)//using splice method to remove element from the array
console.log(removedContact)//splice method returns the removed element
console.log(contacts)//array after removing the element
...
//real world example:Find the index of a specific contact in the contacts array
const contacts1=["Gaurav","Hassan","Vinnet"]//array definition
const indexOfContact=contacts1.indexOf("Hassan")//using indexOf method to find the index of the first occurrence of the element in the array
console.log(indexOfContact)//indexOf method returns the index of the element array14 is just a variable that stores the index of the element and it does not modify the original array also it itself is not an array it is just a variable that stores the index of the element
console.log(contacts1)//original array is not modified after using indexOf method because indexOf method does not modify the original array and returns the index of the element
...
//real world example:Check if a specific contact is present in the contacts array
const contacts2=["Gaurav","Hassan","Vinnet"]//array definition
const isContactPresent=contacts2.includes("Hassan")//using includes method to check whether the element is present in the array or not
console.log(isContactPresent)//includes method returns true or false
console.log(contacts2)//original array is not modified after using includes method because includes method does not modify the original array and returns true or false
...
//real world example:Join the elements of the contacts array into a single string
const contacts3=["Gaurav","Hassan","Vinnet"]//array definition
const joinedContacts=contacts3.join(", ")//using join method to join the elements of the array
console.log(joinedContacts)//join method returns a string
console.log(contacts3)//original array is not modified after using join method because join method does not modify the original array and returns a string
...
//real world example:Flatten a nested array of notifications
const nestedNotifications=["Message from Gaurav","Message from Hassan",["Message from Vinnet","Message from Mayur"],"Message from Rohan"]//array definition
const flattenedNotifications=nestedNotifications.flat()//using flat method to flatten the nested array upto 1 level depth (default is 1) if we want to flatten the nested array upto any level depth then we can use Infinity as the argument in flat method
console.log(flattenedNotifications)//flat method returns a new array
console.log(nestedNotifications)//original array is not modified after using flat method because flat method does not modify the original array and returns a new array 
